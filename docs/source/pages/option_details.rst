...
L'option **Détails** permet d'activer/désactiver les détails de la définition de la Méta. Un détail est un sous-ensemble d'attributs 
d'une entité enfant.
...
Dans toutes le vues, tous les détails sont activés par défaut, mais il est possible de les activer ou les désactiver dans la définition de la Méta.
