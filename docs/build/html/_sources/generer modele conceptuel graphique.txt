...
3. Cliquez sur l'option **doModelGraph** . Un message de confirmation de l'opération sera affiché sur l'interface (voir la barre de messages pour plus de détails).
4. Le modèle graphique généré est ouvert dans un nouvel onglet de votre fureteur. Le format de sortie de la graphique est un fichier PDF.
...
**Propriété requise (obligatoire)** : la police du texte est grasse et sa couleur est gris pâle. Exemples dans la figure : nom_produit et numero_commande.
