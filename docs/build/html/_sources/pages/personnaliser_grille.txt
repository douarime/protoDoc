...
La fonction « exportCsv » apparaît à l'intérieur de la fonction « imprimer » du menu de fonctions. (voir :doc:`imprimer <menu_imprimer>`).

**listDisplay** sert à personnaliser l'affichage et l'ordre d'apparition de champs sur la grille (voir :doc:`option configuration <option_configuration>`).
